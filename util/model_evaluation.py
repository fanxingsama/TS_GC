...
if __name__ == "__main__":
    ...
    # 请将以下路径替换为你自己的文件路径
    TRUE_FILE = "./compare_model_matrix/nolinear/SNR/causal_nolinear.csv"
    # PRED_FILE = "../compare_model/CausalFormer/csv/CausalFormer_timeseries6.csv" # CausalFormer预测矩阵
    # PRED_FILE = "./compare_model_matrix/nolinear/SNR/TS-GC_snr0.csv" # TCDF预测矩阵
    PRED_FILE = "../compare_model/TCDF/TCDF_time_series_nolinear_snr15_causal.csv"  # TS-GC预测矩阵
