...
if __name__ == "__main__":
    # === 配置区域 ===
    # csv_file_path = 'time_series_nolinear_snr-5dB.csv'  # 在这里修改你的CSV文件路径
    # output_folder = 'time_series_nolinear_snr-5dB_图片保存'   # 图片保存的文件夹名称
    csv_file_path = '反再全测点正常数据.csv'  # 在这里修改你的CSV文件路径
    output_folder = '反再全测点正常数据_图片保存'   # 图片保存的文件夹名称
